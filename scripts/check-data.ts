import { pinecone } from '@/utils/pinecone-local-client';
...
export const run = async () => {
    try {
        ...
        const query = await embedder.embedQuery('What is Johnson vs. Alaska about?')//You can change this query and it will re-arrange the results based on score
